...
class MobjectExample(Scene):
    def construct(self):
        ...
        # self.play(Create(choices2), run_time=1)
        # self.wait(1)
        # self.play(Write(MathTex(r"\times").next_to(choices1 , buff=0.5)))
        ...
        # square1 = Rectangle(width=2, height=2).move_to([-6,-2.5,0])
        # square2 = Rectangle(width=2, height=2).move_to([6,-2.5,0])

        square1 = Dot().move_to([-6,-2.5, 0])
        square2 = Dot().move_to([6, -2.5, 0])
